...
r8 = Recipe.create(:name => 'Indian Saag', :image => 'http://lh4.ggpht.com/EnHy4ihWsfVjO3PDwBaTUV6nj4UVukrd4EsYdzlvNIuCZzJDRuapGP2jsqZi1pZo08_1wYTSeDSgH7IBSYRWCA=s230-c', :calories => '360', :cuisine => 'Indian')
